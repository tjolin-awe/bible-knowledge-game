...
function is_there_a_valid_move() {
  ...
  for (var _i = 0; _i < gameOptions.fieldSize; _i++) {
    for (var _j = 0; _j < gameOptions.fieldSize - 1; _j++) {
      var oldij = gameArray[_i][_j];
      gameArray[_i][_j] = gameArray[_i][_j + 1];
      gameArray[_i][_j + 1] = oldij;
      var result = matchInBoard();
      gameArray[_i][_j + 1] = gameArray[_i][_j];
      gameArray[_i][_j] = oldij;
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/task.js"], null)
//# sourceMappingURL=/task.ad45dcea.js.map