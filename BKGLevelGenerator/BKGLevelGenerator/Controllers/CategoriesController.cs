...
namespace BKGLevelGenerator.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(GameDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int? id, int? board)
        {
            ViewBag.Board = board;
            if (id == null)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title")] Category category, int board)
        {
            ViewBag.Board = board;
            if (id != category.Id)
            {
